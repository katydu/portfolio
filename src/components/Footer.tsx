      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            ...
            <p className="text-gray-400">MSc Computer Science Student</p>
          </div>
          ...
          <button onClick={scrollToTop} className="bg-blue-600 p-2 rounded-full hover:bg-blue-700 transition-colors" aria-label="Scroll to top">
            <ArrowUpIcon size={20} />
          </button>
        </div>
